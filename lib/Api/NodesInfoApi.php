...
class NodesInfoApi
{
     ...
     * @return \Killbill\Client\Swagger\Model\NodeInfo[]
     */
     ...
     * @throws \Killbill\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Killbill\Client\Swagger\Model\NodeInfo[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getNodesInfoWithHttpInfo()
    {
        $returnType = '\Killbill\Client\Swagger\Model\NodeInfo[]';
     ...
     * @param bool|null $localNodeOnly localNodeOnly (optional, default to false)
     *
     * @throws \Killbill\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function triggerNodeCommand($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $localNodeOnly = 'false')
    {
     ...
     * @param bool $localNodeOnly (optional, default to false)
     *
     * @throws \Killbill\Client\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function triggerNodeCommandWithHttpInfo($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $localNodeOnly = 'false')
    {
        $returnType = null;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function triggerNodeCommandAsync($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $localNodeOnly = 'false')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function triggerNodeCommandAsyncWithHttpInfo($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $localNodeOnly = 'false')
    {
        $returnType = null;
        $request = $this->triggerNodeCommandRequest($body, $xKillbillCreatedBy, $xKillbillReason, $xKillbillComment, $localNodeOnly);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function triggerNodeCommandRequest($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $localNodeOnly = 'false')
    {
