...
class TagApi
{
     ...
     */
    public function getTags($offset = '0', $limit = '100', $audit = 'NONE')
    {
     ...
     */
    public function getTagsWithHttpInfo($offset = '0', $limit = '100', $audit = 'NONE')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsync($offset = '0', $limit = '100', $audit = 'NONE')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($offset = '0', $limit = '100', $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\Tag[]';
        $request = $this->getTagsRequest($offset, $limit, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTagsRequest($offset = '0', $limit = '100', $audit = 'NONE')
    {
     ...
     * @return \Killbill\Client\Swagger\Model\Tag[]
     */
    public function searchTags($searchKey, $offset = '0', $limit = '100', $audit = 'NONE')
    {
     ...
     * @return array of \Killbill\Client\Swagger\Model\Tag[], HTTP status code, HTTP response headers (array of strings)
     */
    public function searchTagsWithHttpInfo($searchKey, $offset = '0', $limit = '100', $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\Tag[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchTagsAsync($searchKey, $offset = '0', $limit = '100', $audit = 'NONE')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchTagsAsyncWithHttpInfo($searchKey, $offset = '0', $limit = '100', $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\Tag[]';
        $request = $this->searchTagsRequest($searchKey, $offset, $limit, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchTagsRequest($searchKey, $offset = '0', $limit = '100', $audit = 'NONE')
    {
