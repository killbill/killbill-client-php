...
class InvoiceItemApi
{
     ...
     * @return \Killbill\Client\Swagger\Model\CustomField[]
     */
    public function getInvoiceItemCustomFields($invoiceItemId, $audit = 'NONE')
    {
     ...
     * @return array of \Killbill\Client\Swagger\Model\CustomField[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getInvoiceItemCustomFieldsWithHttpInfo($invoiceItemId, $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\CustomField[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceItemCustomFieldsAsync($invoiceItemId, $audit = 'NONE')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceItemCustomFieldsAsyncWithHttpInfo($invoiceItemId, $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\CustomField[]';
        $request = $this->getInvoiceItemCustomFieldsRequest($invoiceItemId, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInvoiceItemCustomFieldsRequest($invoiceItemId, $audit = 'NONE')
    {
        // verify the required parameter 'invoiceItemId' is set
        if ($invoiceItemId === null || (is_array($invoiceItemId) && count($invoiceItemId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Killbill\Client\Swagger\Model\Tag[]
     */
    public function getInvoiceItemTags($invoiceItemId, $accountId, $includedDeleted = 'false', $audit = 'NONE')
    {
     ...
     * @return array of \Killbill\Client\Swagger\Model\Tag[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getInvoiceItemTagsWithHttpInfo($invoiceItemId, $accountId, $includedDeleted = 'false', $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\Tag[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceItemTagsAsync($invoiceItemId, $accountId, $includedDeleted = 'false', $audit = 'NONE')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceItemTagsAsyncWithHttpInfo($invoiceItemId, $accountId, $includedDeleted = 'false', $audit = 'NONE')
    {
        $returnType = '\Killbill\Client\Swagger\Model\Tag[]';
        $request = $this->getInvoiceItemTagsRequest($invoiceItemId, $accountId, $includedDeleted, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInvoiceItemTagsRequest($invoiceItemId, $accountId, $includedDeleted = 'false', $audit = 'NONE')
    {
        // verify the required parameter 'invoiceItemId' is set
        if ($invoiceItemId === null || (is_array($invoiceItemId) && count($invoiceItemId) === 0)) {
            throw new \InvalidArgumentException(
