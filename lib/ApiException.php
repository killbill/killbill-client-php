...
class ApiException extends \Exception
{
     ...
     * @param string|null   $responseBody    HTTP decoded body of the server response
     */
    public function __construct(string $message = '', int $code = 0, ?array $responseHeaders = [], ?string $responseBody = null)
    {
