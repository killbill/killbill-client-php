...
self::CURRENCY_BTC,        ];
    ...
    {
        $this->container['creditId'] = isset($data['creditId']) ? $data['creditId'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['creditAmount'] === null) {
            $invalidProperties[] = "'creditAmount' can't be null";
        }
    ...
    {
        return $this->container['creditId'];
    }

    /**
     * Sets creditId
     *
     * @param string $creditId creditId
     *
     * @return $this
     */
    public function setCreditId($creditId)
    {
        $this->container['creditId'] = $creditId;
