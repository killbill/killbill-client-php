...
class TenantApi
{
     ...
     * Create a tenant
     *
     * @param  \Killbill\Client\Model\Tenant $body body (required)
     ...
     * @return \Killbill\Client\Model\Tenant
     */
    public function createTenant($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $useGlobalDefault = null)
    {
     ...
     * Create a tenant
     *
     * @param  \Killbill\Client\Model\Tenant $body (required)
     ...
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Killbill\Client\Model\Tenant, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTenantWithHttpInfo($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $useGlobalDefault = null)
    {
        $returnType = '\Killbill\Client\Model\Tenant';
     ...
     */
    public function createTenantAsync($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $useGlobalDefault = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTenantAsyncWithHttpInfo($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $useGlobalDefault = null)
    {
        $returnType = '\Killbill\Client\Model\Tenant';
        $request = $this->createTenantRequest($body, $xKillbillCreatedBy, $xKillbillReason, $xKillbillComment, $useGlobalDefault);
     ...
     */
    protected function createTenantRequest($body, $xKillbillCreatedBy, $xKillbillReason = null, $xKillbillComment = null, $useGlobalDefault = null)
    {
     ...
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Killbill\Client\Model\TenantKeyValue
     */
     ...
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Killbill\Client\Model\TenantKeyValue, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllPluginConfigurationWithHttpInfo($keyPrefix)
    {
        $returnType = '\Killbill\Client\Model\TenantKeyValue';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Killbill\Client\Model\TenantKeyValue',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
