...
class PaymentApi
{
     ...
     *
     * @param  \Killbill\Client\Model\ComboPaymentTransaction $body body (required)
     * @param  string $xKillbillCreatedBy xKillbillCreatedBy (required)
     * @param  string $xKillbillReason xKillbillReason (optional)
     * @param  string $xKillbillComment xKillbillComment (optional)
     * @param  string[] $controlPluginName controlPluginName (optional)
     ...
     * Combo api to create a new payment transaction on a existing (or not) account
     *
     * @param  \Killbill\Client\Model\ComboPaymentTransaction $body (required)
     * @param  string $xKillbillCreatedBy (required)
     * @param  string $xKillbillReason (optional)
     * @param  string $xKillbillComment (optional)
     * @param  string[] $controlPluginName (optional)
     ...
     * @return \Killbill\Client\Model\Payment
     */
    public function getPayment($paymentId, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return array of \Killbill\Client\Model\Payment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentWithHttpInfo($paymentId, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentAsync($paymentId, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentAsyncWithHttpInfo($paymentId, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment';
        $request = $this->getPaymentRequest($paymentId, $withPluginInfo, $withAttempts, $pluginProperty, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentRequest($paymentId, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        // verify the required parameter 'paymentId' is set
        if ($paymentId === null || (is_array($paymentId) && count($paymentId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Killbill\Client\Model\Payment
     */
    public function getPaymentByExternalKey($externalKey, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return array of \Killbill\Client\Model\Payment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentByExternalKeyWithHttpInfo($externalKey, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentByExternalKeyAsync($externalKey, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentByExternalKeyAsyncWithHttpInfo($externalKey, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment';
        $request = $this->getPaymentByExternalKeyRequest($externalKey, $withPluginInfo, $withAttempts, $pluginProperty, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentByExternalKeyRequest($externalKey, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return \Killbill\Client\Model\CustomField[]
     */
    public function getPaymentCustomFields($paymentId, $audit = null)
    {
     ...
     * @return array of \Killbill\Client\Model\CustomField[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentCustomFieldsWithHttpInfo($paymentId, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\CustomField[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentCustomFieldsAsync($paymentId, $audit = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentCustomFieldsAsyncWithHttpInfo($paymentId, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\CustomField[]';
        $request = $this->getPaymentCustomFieldsRequest($paymentId, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentCustomFieldsRequest($paymentId, $audit = null)
    {
        // verify the required parameter 'paymentId' is set
        if ($paymentId === null || (is_array($paymentId) && count($paymentId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Killbill\Client\Model\Tag[]
     */
    public function getPaymentTags($paymentId, $includedDeleted = null, $audit = null)
    {
     ...
     * @return array of \Killbill\Client\Model\Tag[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentTagsWithHttpInfo($paymentId, $includedDeleted = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Tag[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentTagsAsync($paymentId, $includedDeleted = null, $audit = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentTagsAsyncWithHttpInfo($paymentId, $includedDeleted = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Tag[]';
        $request = $this->getPaymentTagsRequest($paymentId, $includedDeleted, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentTagsRequest($paymentId, $includedDeleted = null, $audit = null)
    {
        // verify the required parameter 'paymentId' is set
        if ($paymentId === null || (is_array($paymentId) && count($paymentId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Killbill\Client\Model\Payment[]
     */
    public function getPayments($offset = null, $limit = null, $pluginName = null, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return array of \Killbill\Client\Model\Payment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsWithHttpInfo($offset = null, $limit = null, $pluginName = null, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentsAsync($offset = null, $limit = null, $pluginName = null, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentsAsyncWithHttpInfo($offset = null, $limit = null, $pluginName = null, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment[]';
        $request = $this->getPaymentsRequest($offset, $limit, $pluginName, $withPluginInfo, $withAttempts, $pluginProperty, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentsRequest($offset = null, $limit = null, $pluginName = null, $withPluginInfo = null, $withAttempts = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return \Killbill\Client\Model\Payment[]
     */
    public function searchPayments($searchKey, $offset = null, $limit = null, $withPluginInfo = null, $withAttempts = null, $pluginName = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return array of \Killbill\Client\Model\Payment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function searchPaymentsWithHttpInfo($searchKey, $offset = null, $limit = null, $withPluginInfo = null, $withAttempts = null, $pluginName = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchPaymentsAsync($searchKey, $offset = null, $limit = null, $withPluginInfo = null, $withAttempts = null, $pluginName = null, $pluginProperty = null, $audit = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchPaymentsAsyncWithHttpInfo($searchKey, $offset = null, $limit = null, $withPluginInfo = null, $withAttempts = null, $pluginName = null, $pluginProperty = null, $audit = null)
    {
        $returnType = '\Killbill\Client\Model\Payment[]';
        $request = $this->searchPaymentsRequest($searchKey, $offset, $limit, $withPluginInfo, $withAttempts, $pluginName, $pluginProperty, $audit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchPaymentsRequest($searchKey, $offset = null, $limit = null, $withPluginInfo = null, $withAttempts = null, $pluginName = null, $pluginProperty = null, $audit = null)
    {
