...
class SubscriptionApi
{
     ...
     *
     * @param  \Killbill\Client\Model\Subscription $body body (required)
     * @param  string $xKillbillCreatedBy xKillbillCreatedBy (required)
     * @param  string $subscriptionId subscriptionId (required)
     * @param  string $xKillbillReason xKillbillReason (optional)
     * @param  string $xKillbillComment xKillbillComment (optional)
     ...
     * Change entitlement plan
     *
     * @param  \Killbill\Client\Model\Subscription $body (required)
     * @param  string $xKillbillCreatedBy (required)
     * @param  string $subscriptionId (required)
     * @param  string $xKillbillReason (optional)
     * @param  string $xKillbillComment (optional)
     ...
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Killbill\Client\Model\Subscription
     */
     ...
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Killbill\Client\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Killbill\Client\Model\Subscription';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Killbill\Client\Model\Subscription',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Killbill\Client\Model\BulkSubscriptionsBundle[] $body body (required)
     * @param  string $xKillbillCreatedBy xKillbillCreatedBy (required)
     * @param  string $xKillbillReason xKillbillReason (optional)
     * @param  string $xKillbillComment xKillbillComment (optional)
     * @param  \DateTime $entitlementDate entitlementDate (optional)
     ...
     * Create multiple entitlements with addOn products
     *
     * @param  \Killbill\Client\Model\BulkSubscriptionsBundle[] $body (required)
     * @param  string $xKillbillCreatedBy (required)
     * @param  string $xKillbillReason (optional)
     * @param  string $xKillbillComment (optional)
     * @param  \DateTime $entitlementDate (optional)
