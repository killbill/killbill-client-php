...
class InvoiceApi
{
     ...
     *
     * @param  \Killbill\Client\Model\InvoiceItem $body body (required)
     ...
     * Adjust an invoice item
     *
     * @param  \Killbill\Client\Model\InvoiceItem $body (required)
     ...
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Killbill\Client\Model\InvoiceItem[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Killbill\Client\Model\InvoiceItem[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Killbill\Client\Model\InvoiceItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Killbill\Client\Model\InvoicePayment $body body (required)
     * @param  string $xKillbillCreatedBy xKillbillCreatedBy (required)
     * @param  string $invoiceId invoiceId (required)
     * @param  string $xKillbillReason xKillbillReason (optional)
     * @param  string $xKillbillComment xKillbillComment (optional)
     ...
     * Trigger a payment for invoice
     *
     * @param  \Killbill\Client\Model\InvoicePayment $body (required)
     * @param  string $xKillbillCreatedBy (required)
     * @param  string $invoiceId (required)
     * @param  string $xKillbillReason (optional)
     * @param  string $xKillbillComment (optional)
     ...
     *
     * @param  \Killbill\Client\Model\InvoiceDryRun $body body (required)
     * @param  string $xKillbillCreatedBy xKillbillCreatedBy (required)
     * @param  string $accountId accountId (required)
     * @param  string $xKillbillReason xKillbillReason (optional)
     * @param  string $xKillbillComment xKillbillComment (optional)
     ...
     * Generate a dryRun invoice
     *
     * @param  \Killbill\Client\Model\InvoiceDryRun $body (required)
     * @param  string $xKillbillCreatedBy (required)
     * @param  string $accountId (required)
     * @param  string $xKillbillReason (optional)
     * @param  string $xKillbillComment (optional)
     ...
     * @param  bool $withChildrenItems withChildrenItems (optional)
     ...
     * @param  string $xKillbillReason xKillbillReason (optional)
     * @param  string $xKillbillComment xKillbillComment (optional)
     * @param  bool $deleteIfExists deleteIfExists (optional)
     *
     * @throws \Killbill\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
