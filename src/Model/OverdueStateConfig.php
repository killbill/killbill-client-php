...
class OverdueStateConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
'isClearState' => 'bool',
'condition' => '\Killbill\Client\Model\OverdueCondition',
...
self::SUBSCRIPTION_CANCELLATION_POLICY_NONE,        ];
     ...
     * Gets condition
     *
     * @return \Killbill\Client\Model\OverdueCondition
     */
     ...
     * Sets condition
     *
     * @param \Killbill\Client\Model\OverdueCondition $condition condition
     *
     * @return $this
     */
