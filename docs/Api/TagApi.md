...
> \Killbill\Client\Model\AuditLog[] getTagAuditLogsWithHistory($tagId)
...
$apiInstance = new Killbill\Client\Api\TagApi(
...
# **getTags**
> \Killbill\Client\Model\Tag[] getTags($offset, $limit, $audit)
...
# **searchTags**
> \Killbill\Client\Model\Tag[] searchTags($searchKey, $offset, $limit, $audit)
